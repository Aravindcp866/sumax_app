...
const TopPicks = () => {
  return (
    <>
    <div className='text-orange-500 font-bold text-2xl text-center'>TopPicks</div>
            ...
            topPicks.map((item,c)=>
            {
                return(
                    ...
                    <div  className='rounded-3xl relative'>
                        ...
                        <img className='h-[200px] w-full object-cover rounded-3xl cursor-pointer hover:scale-105 ease-out duration-300' src={item.img}></img>
                    </div>
                    </SplideSlide>
                )
